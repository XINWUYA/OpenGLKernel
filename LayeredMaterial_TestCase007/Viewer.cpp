...
void CViewer::drawContentsV()
{
	...
	m_pGLShader->setFloatUniform("u_LightInfo.Direction", m_LightDir.x, m_LightDir.y, m_LightDir.z);
	...
	m_pGLShader->setFloatUniform("u_ClearCoatRoughness", m_ClearCoatRoughness);
	m_pGLShader->setFloatUniform("u_ClearCoatThickness", m_ClearCoatThickness);
	m_pGLShader->setFloatUniform("u_ClearCoatIOR", m_ClearCoatIOR);
	m_pGLShader->setFloatUniform("u_ModelDielectricIOR", m_ModelDielectricIOR);
	m_pGLShader->setFloatUniform("u_ClearCoatTint", m_ClearCoatTint.r, m_ClearCoatTint.g, m_ClearCoatTint.b);
...
void CViewer::__setGUIComponents()
{
	...
	m_pAssistGUI->sliderFloat("LightDir.x", m_LightDir.x, -1.0f, 1.0f);
	m_pAssistGUI->sliderFloat("LightDir.y", m_LightDir.y, -1.0f, 1.0f);
	m_pAssistGUI->sliderFloat("LightDir.z", m_LightDir.z, -1.0f, 1.0f);
	...
	m_pAssistGUI->sliderFloat("ModelDielectricIOR", m_ModelDielectricIOR, 1.0f, 2.5f);
	...
	m_pAssistGUI->sliderFloat("ClearCoatIOR", m_ClearCoatIOR, 1.001f, 2.0f);
	m_pAssistGUI->colorEdit3("ClearCoatTint", &m_ClearCoatTint[0]);
}
