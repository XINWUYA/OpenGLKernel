...
CGraphicsApp::CGraphicsApp(int vWindowWidth, int vWindowHeight, std::string& vWindowName) : m_pGLFWWindow(nullptr), m_pShader(nullptr), m_pLightShader(nullptr), m_pTexture(nullptr), m_pTexture1(nullptr), m_pModel(nullptr)
{
...
void CGraphicsApp::__initShader()
{
	...
	m_pShader->addShader("../ShaderSources/LN010/NanosuitVertShader.glsl", VERTEX_SHADER);
	m_pShader->addShader("../ShaderSources/LN010/NanosuitFragShader.glsl", FRAGMENT_SHADER);
	m_pShader->createShaderProgram();

	m_pLightShader = new CShader();
	m_pLightShader->addShader("../ShaderSources/LN010/LightVertShader.glsl", VERTEX_SHADER);
	m_pLightShader->addShader("../ShaderSources/LN010/LightFragShader.glsl", FRAGMENT_SHADER);
