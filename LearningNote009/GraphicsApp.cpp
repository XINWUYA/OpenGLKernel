...
void CGraphicsApp::__initShader()
{
	...
	m_pShader->addShader("../ShaderSources/LN009/CubeVertShader.glsl", VERTEX_SHADER);
	m_pShader->addShader("../ShaderSources/LN009/CubeFragShader.glsl", FRAGMENT_SHADER);
	m_pShader->createShaderProgram();

	m_pLightShader = new CShader();
	m_pLightShader->addShader("../ShaderSources/LN009/LightVertShader.glsl", VERTEX_SHADER);
	m_pLightShader->addShader("../ShaderSources/LN009/LightFragShader.glsl", FRAGMENT_SHADER);
