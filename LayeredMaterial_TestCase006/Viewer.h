...
private:
	...
	std::shared_ptr<CGLTexture> m_pRoughnessTexture = nullptr;
	std::shared_ptr<CGLTexture> m_pIridescenceThickTexture = nullptr;
	...
	float m_ModelRoughness = 1.0f;
	float m_ModelMetallic = 0.0f;
	float m_Reflectance = 0.5f;
	float m_ClearCoatRoughness = 0.0f;
	float m_ClearCoatThickness = 0.0f;
	float m_ThinFilmIridescene = 1.0f;//彩虹色强度
	float m_ThinFilmThickness = 0.76f;
	float m_ThinFilmIOR = 1.33f;
	float m_ThinFilmExtinctionK = 0.33f;//不知道啥意思
