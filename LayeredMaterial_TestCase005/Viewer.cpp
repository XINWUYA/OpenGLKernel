...
CViewer::CViewer(const std::string& WindowTitle, int vWindowWidth, int vWindowHeight) : CGLScreen(WindowTitle, vWindowWidth, vWindowHeight, false, 8), m_WindowWidth(vWindowWidth), m_WindowHeight(vWindowHeight)
{
	...
	m_pDiffuseTexture = std::make_shared<CGLTexture>("../ModelSources/substance_sphere/wood/albedo.png", Texture);
	m_pNormalTexture = std::make_shared<CGLTexture>("../ModelSources/substance_sphere/wood/normal.png", Texture);
	m_pMetallicTexture = std::make_shared<CGLTexture>("../ModelSources/substance_sphere/wood/metallic.png", Texture);
	m_pRoughnessTexture = std::make_shared<CGLTexture>("../ModelSources/substance_sphere/wood/roughness.png", Texture);
...
void CViewer::__setGUIComponents()
{
	...
	m_pAssistGUI->text("ClearCoat Info:");
